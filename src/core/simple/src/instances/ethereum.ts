...
const MAINNET_PROVIDER = `https://mainnet.infura.io/v3/1f4e1752f49b4ac8b691620c2ff29603`
const TESTNET_PROVIDER = `https://rinkeby.infura.io/v3/1f4e1752f49b4ac8b691620c2ff29603`
...
const ETHERSCAN_APIKEY = `BEAQZTKC5A3VJ1ZYX657NK6APBSDCE6ZSN`

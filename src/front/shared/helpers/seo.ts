const seo = {
  config: {
    ...
    email: 'worldcentum@gmail.com',
    mainUrl: 'https://centumworld.com',
    logo: 'https://storage.centumworld.com/images/cwt.jpeg',
  },
  defaultTitle: 'CWT Wallet with Exchange',
  ...
  pages: [
    {
      uri: '/',
      title: window.defaultWindowTitle || 'CWT Wallet with Exchange',
